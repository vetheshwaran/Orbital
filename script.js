...
function turnOnMove(){
	c.addEventListener('pointermove', orbGo, false);
}

function turnOffMove(){
	c.removeEventListener('pointermove', orbGo, false);
}
...
c.addEventListener('pointerdown', orbGo, false);
c.addEventListener('pointerdown', turnOnMove, false);
c.addEventListener('pointerup', turnOffMove, false);
